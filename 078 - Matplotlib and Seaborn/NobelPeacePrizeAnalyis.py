...
print(f'There are {multiple_winners.full_name.nunique()} multiple winners')
...
prizes_bar.update_layout(xaxis_title = 'Nobel Prize Category',
...
men_women_split = px.bar(x=cat_men_women.category,
                         y=cat_men_women.prize,
                         color=cat_men_women.sex,
                         title='Number of prizes split by Men and Women')

men_women_split.update_layout(xaxis_title='Nobel Prize Category',
                              yaxis_title='Number of Prizes Won')

men_women_split.show()
...
avg_prize_share_yearly = df_data.groupby(by='year').agg({'share_pct': pd.Series.mean})
share_moving_average = avg_prize_share_yearly.rolling(window=5).mean()
