...
print(f'Number of films being released after scrape: {len(not_yet_released)}')
not_yet_released

# Remove yet o be released films.
clean_data = data.drop(not_yet_released.index)
...
(money_losing.shape[0] / clean_data.shape[0]) * 100
...
# Explanatory Variable(s) or Feature(s) for old films
X = pd.DataFrame(old_films, columns=['USD_Production_Budget'])

# Response Variable or Target for old films
